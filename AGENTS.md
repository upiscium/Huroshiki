...
- Enter the pinned toolchain with `direnv allow` or `nix develop`; the shell reuses `packages.huroshiki`, which supplies Python with Textual/PyYAML/tomlkit, Packwiz, Java 21, Just, rsync, and SSH.
